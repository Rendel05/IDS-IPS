...
class SettingsPage(QWidget):
    ...
    def pause_detection(self):
        value = not self.settings.get('monitoring', 'on_paused')
        self.pause_engine.setText("Pausar el motor" if not value else "Reanudar el motor")
        self.settings.set(
            value,
            "monitoring",
            "on_paused"
        )
        self.engine_paused.emit(value)
